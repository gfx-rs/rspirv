...
bitflags! { # [ doc = "SPIR-V operand kind: [ImageOperands](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_image_operands_a_image_operands)" ] pub struct ImageOperands : u32 { const NONE = 0u32 ; const BIAS = 0u32 ; const LOD = 0u32 ; const GRAD = 0u32 ; const CONST_OFFSET = 0u32 ; const OFFSET = 0u32 ; const CONST_OFFSETS = 0u32 ; const SAMPLE = 0u32 ; const MIN_LOD = 0u32 ; const MAKE_TEXEL_AVAILABLE_KHR = 0u32 ; const MAKE_TEXEL_VISIBLE_KHR = 0u32 ; const NON_PRIVATE_TEXEL_KHR = 0u32 ; const VOLATILE_TEXEL_KHR = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [FPFastMathMode](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_fp_fast_math_mode_a_fp_fast_math_mode)" ] pub struct FPFastMathMode : u32 { const NONE = 0u32 ; const NOT_NAN = 0u32 ; const NOT_INF = 0u32 ; const NSZ = 0u32 ; const ALLOW_RECIP = 0u32 ; const FAST = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [SelectionControl](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_selection_control_a_selection_control)" ] pub struct SelectionControl : u32 { const NONE = 0u32 ; const FLATTEN = 0u32 ; const DONT_FLATTEN = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [LoopControl](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_loop_control_a_loop_control)" ] pub struct LoopControl : u32 { const NONE = 0u32 ; const UNROLL = 0u32 ; const DONT_UNROLL = 0u32 ; const DEPENDENCY_INFINITE = 0u32 ; const DEPENDENCY_LENGTH = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [FunctionControl](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_function_control_a_function_control)" ] pub struct FunctionControl : u32 { const NONE = 0u32 ; const INLINE = 0u32 ; const DONT_INLINE = 0u32 ; const PURE = 0u32 ; const CONST = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [MemorySemantics](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_memory_semantics_a_memory_semantics)" ] pub struct MemorySemantics : u32 { const RELAXED = 0u32 ; const NONE = 0u32 ; const ACQUIRE = 0u32 ; const RELEASE = 0u32 ; const ACQUIRE_RELEASE = 0u32 ; const SEQUENTIALLY_CONSISTENT = 0u32 ; const UNIFORM_MEMORY = 0u32 ; const SUBGROUP_MEMORY = 0u32 ; const WORKGROUP_MEMORY = 0u32 ; const CROSS_WORKGROUP_MEMORY = 0u32 ; const ATOMIC_COUNTER_MEMORY = 0u32 ; const IMAGE_MEMORY = 0u32 ; const OUTPUT_MEMORY_KHR = 0u32 ; const MAKE_AVAILABLE_KHR = 0u32 ; const MAKE_VISIBLE_KHR = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [MemoryAccess](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_memory_access_a_memory_access)" ] pub struct MemoryAccess : u32 { const NONE = 0u32 ; const VOLATILE = 0u32 ; const ALIGNED = 0u32 ; const NONTEMPORAL = 0u32 ; const MAKE_POINTER_AVAILABLE_KHR = 0u32 ; const MAKE_POINTER_VISIBLE_KHR = 0u32 ; const NON_PRIVATE_POINTER_KHR = 0u32 ; } }
bitflags! { # [ doc = "SPIR-V operand kind: [KernelProfilingInfo](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_kernel_profiling_info_a_kernel_profiling_info)" ] pub struct KernelProfilingInfo : u32 { const NONE = 0u32 ; const CMD_EXEC_TIME = 0u32 ; } }
