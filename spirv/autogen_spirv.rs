...
impl core::str::FromStr for Decoration {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "StridesizeINTEL" => Ok(Self::StridesizeINTEL),
            "WordsizeINTEL" => Ok(Self::WordsizeINTEL),
            "TrueDualPortINTEL" => Ok(Self::TrueDualPortINTEL),
            ...
            "StallFreeINTEL" => Ok(Self::StallFreeINTEL),
...
impl core::str::FromStr for Capability {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "LongCompositesINTEL" => Ok(Self::LongCompositesINTEL),
            ...
            "FPGAClusterAttributesV2INTEL" => Ok(Self::FPGAClusterAttributesV2INTEL),
