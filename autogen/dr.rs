...
pub fn gen_mr_operand_kinds(grammar: &Vec<structs::OperandKind>) -> TokenStream {
...
pub fn gen_mr_builder_types(grammar: &structs::Grammar) -> TokenStream {
...
pub fn gen_mr_builder_terminator(grammar: &structs::Grammar) -> TokenStream {
    let kinds = &grammar.operand_kinds;
    // Generate build methods for all types.
    let elements = grammar.instructions.iter().filter(|inst| {
...
pub fn gen_mr_builder_normal_insts(grammar: &structs::Grammar) -> TokenStream {
    let kinds = &grammar.operand_kinds;
...
pub fn gen_mr_builder_constants(grammar: &structs::Grammar) -> TokenStream {
    let kinds = &grammar.operand_kinds;
...
pub fn gen_mr_builder_debug(grammar: &structs::Grammar) -> TokenStream {
    let kinds = &grammar.operand_kinds;
    // Generate build methods for all constants.
    let elements = grammar.instructions.iter().filter(|inst| {
...
pub fn gen_mr_builder_annotation(grammar: &structs::Grammar) -> TokenStream {
    let kinds = &grammar.operand_kinds;
    // Generate build methods for all constants.
    let elements = grammar.instructions.iter().filter(|inst| {
