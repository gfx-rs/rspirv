...
impl Builder {
    ...
    pub fn type_int(&mut self, result_id: Option<spirv::Word>, width: u32, signedness: u32) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_vector(&mut self, result_id: Option<spirv::Word>, component_type: spirv::Word, component_count: u32) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_matrix(&mut self, result_id: Option<spirv::Word>, column_type: spirv::Word, column_count: u32) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_image(&mut self, result_id: Option<spirv::Word>, sampled_type: spirv::Word, dim: spirv::Dim, depth: u32, arrayed: u32, ms: u32, sampled: u32, image_format: spirv::ImageFormat, access_qualifier: Option<spirv::AccessQualifier>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_sampled_image(&mut self, result_id: Option<spirv::Word>, image_type: spirv::Word) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_array(&mut self, result_id: Option<spirv::Word>, element_type: spirv::Word, length: spirv::Word) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_runtime_array(&mut self, result_id: Option<spirv::Word>, element_type: spirv::Word) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_struct(&mut self, result_id: Option<spirv::Word>, field_types: Vec<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_opaque(&mut self, result_id: Option<spirv::Word>, type_name: String) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_pointer(&mut self, result_id: Option<spirv::Word>, storage_class: spirv::StorageClass, pointee_type: spirv::Word) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_function(&mut self, result_id: Option<spirv::Word>, return_type: spirv::Word, parameter_types: Vec<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn type_pipe(&mut self, result_id: Option<spirv::Word>, qualifier: spirv::AccessQualifier) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
