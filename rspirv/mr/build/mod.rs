...
#[derive(Default)]
pub struct Phi {
    //TODO: figure out if both should be Some()
...
impl Builder {
    ...
    pub fn memory_model(
        ...
        let inst = mr::Instruction::new(
            ...
            None,
            vec![
                mr::Operand::AddressingModel(addressing_model),
...
mod tests {
    ...
    fn test_memory_model() {
        ...
        assert_eq!(
            mr::Operand::from(spirv::AddressingModel::Logical),
            inst.operands[0]
        );
        assert_eq!(
            mr::Operand::from(spirv::MemoryModel::Simple),
            inst.operands[1]
        );
    }
