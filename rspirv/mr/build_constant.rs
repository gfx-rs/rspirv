...
impl Builder {
    ...
    pub fn constant_true(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>) -> spirv::Word {
    ...
    pub fn constant_false(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn constant_composite(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>, constituents: Vec<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn constant_sampler(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>, sampler_addressing_mode: spirv::SamplerAddressingMode, param: u32, sampler_filter_mode: spirv::SamplerFilterMode) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn constant_null(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn spec_constant_true(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn spec_constant_false(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn spec_constant_composite(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>, constituents: Vec<spirv::Word>) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn spec_constant_op(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>, opcode: spirv::Op) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
    ...
    pub fn constant_pipe_storage(&mut self, result_type: spirv::Word, result_id: Option<spirv::Word>, packet_size: u32, packet_alignment: u32, capacity: u32) -> spirv::Word {
        let id = match result_id {
            Some(v) => v,
            None => self.id(),
        };
