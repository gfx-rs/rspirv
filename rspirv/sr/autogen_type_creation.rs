...
impl Context {
    ...
    pub fn type_sampled_image(&mut self, image_type: Token<super::types::Type>) -> Token<Type> {
        self.types.fetch_or_append(Type {
    ...
    pub fn type_runtime_array(&mut self, element_type: Token<super::types::Type>) -> Token<Type> {
        self.types.fetch_or_append(Type {
